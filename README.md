...
BM.py contains the class BoltzmannM, which is a simple implementation of the most basic conceptualisation of the Boltzmann Machine (so far only with visible neurons).
